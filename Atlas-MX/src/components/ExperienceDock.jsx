...
import { BarChart3, CalendarDays, Sparkles, Utensils } from 'lucide-react';

export default function ExperienceDock({ onOpenPlanner, onOpenCompare, onOpenQuiz, onOpenFood }) {
