import { f as PaletaInput, e as Paleta, E as Estado } from './colores-Db1M1O2G.js';

interface OpcionesMapaSVG {
...
declare function mapaSVG(opts?: OpcionesMapaSVG): string;
interface OpcionesMosaicoSVG {
    data?: Record<string, number>;
    categorias?: Record<string, string>;
    paleta?: PaletaInput;
    colorRange?: [string, string];
 ...
 */
declare function mosaicoSVG(opts?: OpcionesMosaicoSVG): string;

export { type OpcionesMapaSVG, type OpcionesMosaicoSVG, mapaSVG, mosaicoSVG };
